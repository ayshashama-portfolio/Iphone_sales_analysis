...
4. The strongest co-purchase relationship exists between `Product_27` and `Product_62`, indicating a high potential for cross-selling. [See visualization](https://github.com/ayshashama-portfolio/Iphone_sales_analysis/blob/main/Visualizations/Top%2010%20Co-purchased%20Product%20Pairs.png)
